...
Användaren behöver skriva kommandoraden \textbf{\textit{ruby ETL.rb}} i terminalen för att kunna köra programmet.
...
Detta görs genom att skriva \textbf{"<<"} för att ignorera en rad. För att ignorera fler rader måste det skrivas 
